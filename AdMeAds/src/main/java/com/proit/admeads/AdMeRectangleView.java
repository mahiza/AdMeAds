...
public class AdMeRectangleView extends RelativeLayout {

    public AdMeRectangleView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    private void initView(Context context) {
        inflate(getContext(), R.layout.adme_rectangle, this);
